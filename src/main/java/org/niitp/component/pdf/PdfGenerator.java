...
import org.niitp.service.ChannelService;
...
public class PdfGenerator {
    ...
    public byte[] createPdf(String templateName, ProductData object) {
        ...
        context.setVariable("addInfo", object.getAddInfo());
    ...
    private String checkSceneTime(String data) {
        if (data.contains(":")) {
            ...
            data = strlist[0] + " час " + strlist[1] + " мин " + newInt + " сек";
        }
        return data;
    }
